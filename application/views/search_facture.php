    ...
    <div class="col-lg-6">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form action="<?php bu('Facture/see_facture')?>" method="get">
            <div class="row mb-3">
              <label for="inputText" class="col-sm-2 col-form-label" >Facture numero</label>
              <div class="col-sm-10">
                <select name="id" id="">
                  <?php
                  for ($i=0; $i < count($list); $i++) { 
                    ?>
                    <option value="<?php echo $list[$i]['id_facture']?>"><?php echo $list[$i]['numero']?></option>
                    <?php
                  }
                  ?>
                </select>
