...
CREATE  TABLE facture ( 
	...
	montant_ht           DECIMAL(20,5)  NOT NULL     ,
	montant_tva          DECIMAL(20,5)  NOT NULL     ,
	monntant_ttc         DECIMAL(20,5)  NOT NULL     ,
	montant_avance       DECIMAL(20,5)  NOT NULL     ,
	net_payer            DECIMAL(20,5)  NOT NULL     
 );

CREATE  TABLE liste_facture ( 
	id_liste_facture     INT  NOT NULL   AUTO_INCREMENT  PRIMARY KEY,
	designation          VARCHAR(30)  NOT NULL     ,
	idunite                int     ,
	nombre               DOUBLE  NOT NULL     ,
	prix_unitaire        DECIMAL(20,5)  NOT NULL     ,
	montant              DECIMAL(20,5)  NOT NULL     ,
	id_facture           INT  NOT NULL     ,
	CONSTRAINT fk_liste_facture_facture FOREIGN KEY ( id_facture ) REFERENCES facture( id_facture ) ON DELETE NO ACTION ON UPDATE NO ACTION,
	FOREIGN KEY ( idunite ) REFERENCES unite_oeuvre( id ) ON DELETE NO ACTION ON UPDATE NO ACTION
 );

CREATE  TABLE client_facture ( 
	id_client_facture    INT  NOT NULL   AUTO_INCREMENT  PRIMARY KEY,
